            ...
            <td className="px-4 py-4 text-sm text-gray-500">{status ? <span> &#9989; </span> : <span> &#10060; </span>} | {paid ? <span> &#9989; </span> : <span> &#10060; </span>} | {delivered ? <span> &#9989; </span> : <span> &#10060; </span>} </td>
            {
                ...
                <div id={`dropdownDivider+${index}`} className="hidden uppercase text-xs font-bold bg-white divide-y divide-gray-100 rounded shadow w-30 dark:bg-gray-700 dark:divide-gray-600">
                    <ul className="list-none" aria-labelledby="dropdownDividerButton">
                        ...
                        <li>
                            <a href="#" className="block px-4 py-2 text-2xs text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white" onClick={() => { alertForUpdatePayment(_id, {paid: true}) }}> Paid </a>
                        </li>
                        <li>
                    ...
                    <div className="py-1">
                        ...
                        <a href="#" className="block px-4 py-2 text-2xs text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white" onClick={() => alertForUpdatePayment(_id, {paid: false})} >Undo Pay</a>
