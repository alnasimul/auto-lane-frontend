...
const Appointments = ({appointments, handleDateChange, searchForm, handleSearchForm}) => {
    ...
    return (
        <div className="grid md:grid-cols-2 sm:flex">
            ...
            <div className="w-full text-center sm:text-left px-3 sm:px-5 py-6 bg-white rounded-lg md:mt-12 lg:ml-20 sm:w-2/4">
                <button className="bg-green-700 hover:bg-green-800 text-white p-2 font-bold rounded-lg" onClick={() => handleSearchForm(true)}> <div className="flex"><FaSearch className="mt-1 mr-2"/> Search </div> </button>
                {
                    searchForm ? <div className="mt-4">
            ...
            </div>
            {
                ...
                <AppointmentsTable appointments={appointments} updateCompletionStatus={updateCompletionStatus} updatePaymentStatus={updatePaymentStatus} updateDeliveryStatus={updateDeliveryStatus} deleteAppointment={deleteAppointment} user={false}/>
